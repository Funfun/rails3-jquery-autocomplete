...
(function(jQuery)
{
  ...
  jQuery.railsAutocomplete.fn.extend({
    init: function(e) {
      ...
      function selectItem(selector, wayToSelect, directionSwitched, fromIndex){
        var self = selector,
      ...
      function directSelectItem(selector, directionSwitched, fromIndex){
        return selectItem(selector, 'direct', directionSwitched, fromIndex);
      };

      function reverseSelectItem(selector, directionSwitched, fromIndex){
        return selectItem(selector, 'reverse', directionSwitched, fromIndex);
      };
