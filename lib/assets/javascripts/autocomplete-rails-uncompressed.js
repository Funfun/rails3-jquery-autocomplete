...
(function(jQuery)
{
  var self = null, firstVisited = true, upToCounter = 0, prevKey, skip = 0, prevSkip = 0, stopIteration = false;
		  ...
		  $(e).keydown(function(event){
		  	var keyCode = $.ui.keyCode;
				...
				case keyCode.UP:
					...
					upToCounter = 0;					
					prevSkip = prevKey == keyCode.DOWN ? skip : (!stopIteration ? prevSkip : 0);
					console.log("prevSkip", prevSkip); 				
					item = reverseSelectItem('.ui-menu li a', prevKey == keyCode.DOWN, prevSkip);
				...
				case keyCode.DOWN:					
					upToCounter = 0;
					prevSkip = prevKey == keyCode.UP ? skip : (!stopIteration ? prevSkip : 0);
					item = directSelectItem('.ui-menu li a', prevKey == keyCode.UP, prevSkip);
					skip = item.current_index;
					stopIteration = item.iteration;	 			  
